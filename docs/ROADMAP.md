...
- **v0.6 emergency services:** team assets, training/rank integration, radio, complete duty workflow.
- **v0.7 MDT and dispatch:** production UI, durable closed incidents, MemoryStore snapshots and warrant workflow.
- **v0.8 administration and applications:** staff permission provider, review queues, suspensions and moderation tools.
- **v0.9 integration and balancing:** load tests, failure drills, analytics, accessibility and economy tuning.
- **v1.0 production release:** content, security review, migration rehearsal, operational dashboards and release gates.
